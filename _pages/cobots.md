...
Recent advances in physical AI and robotic foundation models make human-robot interaction more important, not less. Real-world robots must still understand human intent, predict behavior, and adapt safely in shared environments, whether these capabilities are engineered explicitly or emerge from large-scale models.
...
<div class="project-row">
  ...
  <div class="description">
    <h3>Human-Intent-Aware Robot Planning
    <a href="https://ieeexplore.ieee.org/abstract/document/8990024" target="_blank" rel="noopener noreferrer">[pdf]</a>
    </h3>
    <p>
...
<div class="project-row">
  ...
  <div class="description">
    <h3>Learning High-Level Collaborative Robot Policies from Single-Agent Demonstrations 
       <a href="https://ieeexplore.ieee.org/abstract/document/9345470" target="_blank" rel="noopener noreferrer">[pdf]</a>
       </h3>
    <p>
...
<div class="project-row">
  ...
  <div class="description">
    <h3>Online Learning Neural Network for Short-term Trajectory Prediction
    <a href="https://ieeexplore.ieee.org/abstract/document/8814980" target="_blank" rel="noopener noreferrer">[pdf]</a>
    </h3>
    <p>
...
<div class="project-row">
  ...
  <div class="description">
    <h3>Long-Term Human Trajectory Prediction Using Adaptable Sigma Lognormal Functions 
    <a href="https://ieeexplore.ieee.org/abstract/document/9599389" target="_blank" rel="noopener noreferrer">[pdf]</a>
    </h3>
    <p>
